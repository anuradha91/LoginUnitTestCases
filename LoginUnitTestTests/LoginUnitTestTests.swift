...
class LoginUnitTestTests: XCTestCase {
    ...
    func testInvalidPasswordLengthEndToEnd() {
        ...
        vcLogin.username.text = "anuradha"
    ...
    func testSuccessfullValidation() {
        ...
        loginService.login(withUsername: "anuradha", password: "aK8oio")
    ...
    func testPasswordLengthValidation() {
        ...
        let loginService = LoginServiceDelegate(delegate: actionDelegate)
        loginService.login(withUsername: "anuradha", password: "a")
    ...
    func testPasswordCharacterValidation() {
        ...
        let loginService = LoginServiceDelegate(delegate: actionDelegate)
        loginService.login(withUsername: "anuradha", password: "abjkop")
